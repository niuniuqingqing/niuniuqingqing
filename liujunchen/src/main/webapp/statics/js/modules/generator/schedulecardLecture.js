$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'schedulecard/selfLectrue',
        datatype: "json",
        colModel: [			
			...
			{ label: '教师', name: 'teacher', index: 'teacher', width: 80 }, 
...
var vm = new Vue({
	...
	methods: {
		...
		submit: function (event) {
			...
			var url = vm.scheduleCard.id == null ? "schedulecard/submit" : "schedulecard/submit";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
			    contentType: "application/json",
