...
import indi.liujunchen.admin.modules.sys.service.impl.SysUserServiceImpl;
...
public class SysLoginController {
	...
	public R login(String username, String password, String captcha,String android)throws IOException {
		if("true".equals(android)){
		}else{
	...
	public R register(String username, String password, String captcha,String android)throws IOException {
		if("true".equals(android)){
		}else{
			String kaptcha = ShiroUtils.getKaptcha(Constants.KAPTCHA_SESSION_KEY);
			if(!captcha.equalsIgnoreCase(kaptcha)){
